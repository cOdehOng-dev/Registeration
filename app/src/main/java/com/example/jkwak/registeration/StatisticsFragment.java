...
public class StatisticsFragment extends Fragment {
    ...
    class BackgroundTask extends AsyncTask<Void, Void, String> {
        ...
        protected void onPreExecute() {
            try
            {
                target = "http://ghdtjrdn0323.cafe24.com/StatisticsCourseList.php?userID=" + URLEncoder.encode(MainActivity.userID, "UTF-8");
            }
            catch (Exception e)
            {
                e.printStackTrace();
        ...
        public void onPostExecute(String result) {
            try {
                ...
                while (count < jsonArray.length())
                {
                    ...
                    courseList.add(new Course(courseID, courseGrade, courseTitle, courseNumber, courseHour, courseRoom, courseCredit));
                    count++;
                }
